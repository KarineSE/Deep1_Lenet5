...
class Trainer:
    ...
    def train_one_epoch(self) -> tuple[float, float]:
        ...
        for batch_idx, (inputs, targets) in enumerate(train_dataloader):
            ...
            correct_labeled_samples += (pred.argmax(1) == targets).sum().item()
    ...
    def evaluate_model_on_dataloader(
        ...
        Returns:
            ...
            accuracy across all dataset samples.
        """
        self.model.eval()  # will also automatically disable the Dropout layer for accuracy calculation
    ...
    def write_output(logging_parameters: LoggingParameters, data: dict, output_dir: str):
        ...
        if os.path.exists(output_filepath):
            ...
            all_output_data = []
        data['weights'] = logging_parameters.weights_name
        data['lr'] = logging_parameters.lr
        data['epochs'] = logging_parameters.epochs
